...
#include "../../../../../New folder (3)/DIE-engine/XQwt/3rdparty/qwt/src/qwt_plot_magnifier.h"
...
struct qt_meta_stringdata_CLASSQwtPlotMagnifierENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQwtPlotMagnifierENDCLASS = QtMocHelpers::stringData(
    "QwtPlotMagnifier",
    "rescale",
    "",
    "factor"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQwtPlotMagnifierENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QwtPlotMagnifier::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQwtPlotMagnifierENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQwtPlotMagnifierENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQwtPlotMagnifierENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QwtPlotMagnifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQwtPlotMagnifierENDCLASS.stringdata0))
