...
public:
    ...
    void setupUi(QDialog *DialogSelectStyle)
    {
        if (DialogSelectStyle->objectName().isEmpty())
            DialogSelectStyle->setObjectName(QString::fromUtf8("DialogSelectStyle"));
        ...
        toolButtonStyle1->setObjectName(QString::fromUtf8("toolButtonStyle1"));
        ...
        toolButtonStyle2->setObjectName(QString::fromUtf8("toolButtonStyle2"));
