...
#include "../../../../../New folder (3)/DIE-engine/gui_source/dialogoptions.h"
...
struct qt_meta_stringdata_CLASSDialogOptionsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDialogOptionsENDCLASS = QtMocHelpers::stringData(
    "DialogOptions"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDialogOptionsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DialogOptions::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDialogOptionsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDialogOptionsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDialogOptionsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDialogOptionsENDCLASS.stringdata0))
