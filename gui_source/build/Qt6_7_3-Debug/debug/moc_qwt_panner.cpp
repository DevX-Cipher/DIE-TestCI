...
#include "../../../../../New folder (3)/DIE-engine/XQwt/3rdparty/qwt/src/qwt_panner.h"
...
struct qt_meta_stringdata_CLASSQwtPannerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQwtPannerENDCLASS = QtMocHelpers::stringData(
    "QwtPanner",
    "panned",
    "",
    "dx",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQwtPannerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QwtPanner::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQwtPannerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQwtPannerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQwtPannerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QwtPanner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQwtPannerENDCLASS.stringdata0))
